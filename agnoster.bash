...
# Bash v3 and v4
#
# Updated by Foad Jafarinejad (https://gitlab.com/foadjn), May 29, 2020
# Tested on Ubuntu
#
# # README
#
...
# THEME="$HOME/.bash/themes/agnoster_bash/agnoster.bash"
# if [[ -f $THEME ]]; then
#     source $THEME
# fi
...
# appropriate.
#
# In this version, the $pwd is visible, besides the name of the user and host
# also, for the virtual environment a [] will add for better understanding.
# In the end, $ moved to the next line for better view and understanding 
# of the command. The rest of the code, is as similar as before.

# note: requires bash v4+... Mac users - you often have bash3.
# 'brew install bash' will set you free
# You can uncomment the following line to see only the last two directories
...
prompt_context() {
    ...
    prompt_segment black default "\[\033[1;32m\]\u\[\033[1;33m\] @ \[\033[1;32m\]\h"
